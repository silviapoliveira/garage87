        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleAssignment_Employees_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LabourHours = table.Column<int>(type: "int", nullable: false),
                    EmployeeId = table.Column<int>(type: "int", nullable: true),
                    VehicleId = table.Column<int>(type: "int", nullable: true),
                    VehicleAssignmentId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Repair_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Repair_VehicleAssignment_VehicleAssignmentId",
                        column: x => x.VehicleAssignmentId,
                        principalTable: "VehicleAssignment",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RepairDetail_Repair_RepairId",
                        column: x => x.RepairId,
                        principalTable: "Repair",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RepairDetail_Services_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Repair_VehicleAssignmentId",
                table: "Repair",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepairDetail_RepairId",
                table: "RepairDetail",
                column: "RepairId");

            migrationBuilder.CreateIndex(
                name: "IX_RepairDetail_ServiceId",
                table: "RepairDetail",
                column: "ServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleAssignment_EmployeeId",
